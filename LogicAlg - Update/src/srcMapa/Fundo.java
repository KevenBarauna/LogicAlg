...
ImageIcon referencia = new ImageIcon("src\\ImagensMapa\\fase.png"); // CRIANDO A IMAGEM DO FUNDO PEGANDO A IAMGEM DA - src\\Imagens\\fase.png
imagem = referencia.getImage();// "IMAGEM" VAI RECEBER A IMAGEM QUE ESTA NA PASTA

this.x=(-3627); // O FUNDO VAI COMEÇAR NA POSIÇÃO X = 0
