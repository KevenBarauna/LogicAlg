...
import srcCasaNova01.JanelasCasa01;

public class CasaUm extends JFrame {
...
public CasaUm() {
    ...
    Icon Pegar_Imagem = new ImageIcon("src\\ImagensMapa\\OPERADORES.png ");
    ...
    setVisible(true);
    setResizable(false);
    CasaUm.EscolhaBotao executar = new CasaUm.EscolhaBotao();
