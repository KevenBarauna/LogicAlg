...
public class TapeteErradoPia extends JFrame{
    
    private JLabel tapete_errado;
    private JButton ok;  

    public TapeteErradoPia() {
        ...
        JLabel conteudo = new JLabel("Sempre lave as mãos antes de pegar em um alimento."); //Informações que serão colocados na janela
