...
public class TapeteErradoMesa extends JFrame{
    
    private JLabel tapete_errado;
    private JButton ok;  

    public TapeteErradoMesa() {
        ...
        JLabel conteudo = new JLabel("Tempere a carne primeiro."); //Informações que serão colocados na janela
