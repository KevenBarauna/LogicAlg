...
public class PersonagemCasa01 extends JFrame{
    ...
    public PersonagemCasa01() { // Terá que criar um cnstrutor para que a imagem apareça e o local onde ela vai ficar na tela. 
        //Foi criada uma pasta com as imagem que vai ser colocadas no jogo.
        ImageIcon imagem_pasta = new ImageIcon("src\\imagemCasaNova01\\direito.png");// Para pegar a imagem que esta na pasta, será criado um objeto do tipo o ImageIcon.
...
//-------------Escolha Porta 03 ------------
    ...
    if (botao_escolhido == KeyEvent.VK_LEFT){//Se for igual a seta para esquerda.
        ...
        ImageIcon imagem_pasta = new ImageIcon("src\\imagemCasaNova01\\personagem_esquerda.gif"); 
    ...
    if (botao_escolhido == KeyEvent.VK_RIGHT){//Se for igual a seta para diraita
        ...
        ImageIcon imagem_pasta = new ImageIcon("src\\imagemCasaNova01\\personagem_direita.gif"); 
        imagempersonagem = imagem_pasta.getImage();    
    }  
    ...
    if (botao_escolhido == KeyEvent.VK_LEFT){//Se for igual a seta para esquerda.
        ...
        ImageIcon imagem_pasta = new ImageIcon("src\\imagemCasaNova01\\esquerda.png"); 
        imagempersonagem = imagem_pasta.getImage();        
    }
    if (botao_escolhido == KeyEvent.VK_RIGHT){//Se for igual a seta para diraita
        Coord_M_x = 0; // Se o usuario for para direita a posição que ele esta vai aumentar.
        ImageIcon imagem_pasta = new ImageIcon("src\\imagemCasaNova01\\direito.png"); 
        imagempersonagem = imagem_pasta.getImage();        
