...
public class JanelasRaphael extends JFrame {//Criar uma classe que vai abriu uma janela para o jogo.
//Essa classe vai estender o JFrame, pra criar as telas, para estender usamos Extendes

public JanelasRaphael() {// Para construir as telas, vamos criar um contrutor da classe, que receber métodos para configuar as janelas.
    ...
    JOptionPane.showMessageDialog(null,"LogicAlg - Esta etapa do projeto foi desenvolvida por Raphael Carvalho Monteiro", "Informações", JOptionPane.INFORMATION_MESSAGE);
    }
    });
    ...
    add(new FaseRaphael()); 
    setTitle("Lógica das Portas");// Este método setTitle vai permiti que seja criado um titulo para a tela.
