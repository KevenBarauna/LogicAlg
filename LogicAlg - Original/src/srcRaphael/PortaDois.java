...
public class PortaDois extends JFrame{
    ...
    public PortaDois() {
        ...
        setSize(450,120);// Este método vai criar o tamalho da janela, neste caso x=coluna e y=linha, nesta ordem
        decisao = new JLabel(); 
        this.add(decisao);
        ...
        conteudo = new JLabel("Boolean representa valor 0 como Falso/False e 1 como Verdadeiro/True. :(");
