...
public class Personagem {
    ...
    public Personagem() {
        ...
        ImageIcon referencia = new ImageIcon("src\\ImagensKeven\\Boneco.png"); // CRIANDO O PERSONAGEM E PEGANDO A IAMGEM DA - src\\Imagens\\Boneco.png
...
//   }
    ...
    if (codigo == KeyEvent.VK_LEFT){//SE FOR PRA ESQUERDA
      //  dx = -1;
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagensKeven\\Esquerda.gif");//.gif 
        imagem = imagem_pasta.getImage();
    }
    if (codigo == KeyEvent.VK_RIGHT){//SE FOR PRA DIREITA
        dx = 1;
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagensKeven\\Direita.gif");//.gif 
        imagem = imagem_pasta.getImage();    
    }
    ...
    if (codigo == KeyEvent.VK_LEFT){//SE FOR PRA ESQUERDA
        //dx = 0;
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagensKeven\\esquerdaPerso.png"); 
        imagem = imagem_pasta.getImage();        
    }
    
    if (codigo == KeyEvent.VK_RIGHT){//SE FOR PRA DIREITA
        dx = 0;
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagensKeven\\Boneco.png"); 
       imagem = imagem_pasta.getImage();        
    }
