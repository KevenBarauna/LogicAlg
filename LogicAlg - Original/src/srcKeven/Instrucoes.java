...
public Instrucoes() {
    ...
    Icon Pegar_Imagem = new ImageIcon("src\\ImagensKeven\\MAPA_TELA_02.png");
    instrucao = new JButton(Pegar_Imagem);
    add(instrucao);
    setTitle("Instruções");
    ...
    instrucao.addActionListener(executar);   
}
