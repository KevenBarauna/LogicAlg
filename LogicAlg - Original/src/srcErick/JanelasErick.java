...
public class JanelasErick extends JFrame{//Criar uma classe que vai abriu uma janela para o jogo.
//Essa classe vai estender o JFrame, pra criar as telas, para estender usamos Extendes

public JanelasErick() {// Para construir as telas, vamos criar um contrutor da classe, que receber métodos para configuar as janelas.
    ...
    JOptionPane.showMessageDialog(null,"LogicAlg - Esta etapa do projeto foi desenvolvida por Erick Vinicius Pinto dos Santos", "Informações", JOptionPane.INFORMATION_MESSAGE);
    }
    });
    ...
    add(new FaseErick());//Vai criar uma fase na janela
