...
public class OrdemCorreta extends JFrame{
    ...
    public OrdemCorreta() {
        ...
        setTitle("Acesse a ordem correta");//Criar o Titulo
        ...
        JLabel  conteudo = new JLabel("Acesse as vendas na ordem correta :)"); //Informações que serão colocados na janela
