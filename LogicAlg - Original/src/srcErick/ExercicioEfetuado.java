...
public class ExercicioEfetuado extends JFrame{
    
    private JLabel exerciciorealizado;
    private JButton ok;  

    public ExercicioEfetuado() {

        setTitle("Exercicio Efetuado");//Criar o Titulo
        ...
        JLabel  conteudo = new JLabel("Você já acessou esta venda, procure outro vendedor."); //Informações que serão colocados na janela
