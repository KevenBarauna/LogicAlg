...
public class ReceitaPronta extends JFrame{
    private JButton finalizar;
    
    
  public ReceitaPronta() {
    ...
    setJMenuBar(barramenu); 
      ...
      Icon Prato_Pronto = new ImageIcon("src\\imagemLeonardoErick\\Prato_Pronto.png");
      finalizar = new JButton(Prato_Pronto);
      add(finalizar);
      setTitle("Receita Pronta");
