...
public class TapeteErradoFogao extends JFrame{
    
    private JLabel tapete_errado;

    private JButton ok;  

    public TapeteErradoFogao() {
        ...
        JLabel conteudo = new JLabel("Frite a carne."); //Informações que serão colocados na janela
