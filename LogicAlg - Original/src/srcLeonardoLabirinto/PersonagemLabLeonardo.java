...
public class PersonagemLabLeonardo extends JFrame{
    ...
    public PersonagemLabLeonardo() { // Terá que criar um cnstrutor para que a imagem apareça e o local onde ela vai ficar na tela. 
        ...
        this.Coord_P_x=50;//Local do personagem na tela: "coluna".
        this.Coord_P_y=540;//Local do personagem na tela: "linha".
    }
...
//--------------Não utrapassar a Parede---------------------------------------------------------------------------------------------        
       if (Coord_P_x<=46){ // Para não ultrapassar a parede esquerda.
       Coord_P_x=46+1;  
       }
       if (Coord_P_y<=46){ // Para não ultrapassar a parede de cima.
       Coord_P_y=46+1;
       }
       if (Coord_P_x>=1152){ // Para não ultrapassar a parede direita.
       Coord_P_x=1152-1;  
       }
       if (Coord_P_y>=550){ // Para não ultrapassar a parede de baixo.
       Coord_P_y=550-1;
        
       }       
  
   //--------------------------Paredes do labirinto horizontal-------------    
       

        if (((Coord_P_y>=361 && Coord_P_y<=365)&&(Coord_P_x>46 && Coord_P_x<280)) || ((Coord_P_y>=361 && Coord_P_y<=365)&&(Coord_P_x>550 && Coord_P_x<782)) || ((Coord_P_y>=361 && Coord_P_y<=365) && (Coord_P_x>910 && Coord_P_x<1147))){ 
       Coord_P_y=361-1;
       }        
       
        if (((Coord_P_y>=530 && Coord_P_y<=533)&&(Coord_P_x>46 && Coord_P_x<396)) || ((Coord_P_y>=530 && Coord_P_y<=533)&&(Coord_P_x>430 && Coord_P_x<653))|| ((Coord_P_y>=530 && Coord_P_y<=533)&&(Coord_P_x>790 && Coord_P_x<1147))){ 
       Coord_P_y=533+1;
       } 


        if (((Coord_P_y>=172 && Coord_P_y<=176)&&(Coord_P_x>79 && Coord_P_x<396)) || ((Coord_P_y>=172 && Coord_P_y<=176)&&(Coord_P_x>740 && Coord_P_x<1140))){ 
       Coord_P_y=172-1;
       }        
       
        if (((Coord_P_y>=340 && Coord_P_y<=345)&&(Coord_P_x>79 && Coord_P_x<286)) || ((Coord_P_y>=340 && Coord_P_y<=345)&&(Coord_P_x>619 && Coord_P_x<1140))){ 
       Coord_P_y=345+1;
       }       

        if (((Coord_P_y>=150 && Coord_P_y<=154)&&(Coord_P_x>46 && Coord_P_x<423)) || ((Coord_P_y>=150 && Coord_P_y<=154)&&(Coord_P_x>702 && Coord_P_x<1152))){ 
       Coord_P_y=154+1;
       } 

        if ((Coord_P_y>=60 && Coord_P_y<=65)&&(Coord_P_x>430 && Coord_P_x<562)){ 
       Coord_P_y=60-1;
       }  
   //--------------------------Paredes do labirinto Vertical-------------        

        if (Coord_P_x==396 && (Coord_P_y>172 && Coord_P_y<530) ){  
        Coord_P_x=396+1;
        }    
        
        if (Coord_P_x==264 && (Coord_P_y>340 && Coord_P_y<361) ){ 
        Coord_P_x=264-1;
        }          

        if (Coord_P_x==79 && (Coord_P_y>172 && Coord_P_y<340) ){ 
        Coord_P_x=79-1;
        }         
        
        if (Coord_P_x==422 && (Coord_P_y>46 && Coord_P_y<154) ){  
        Coord_P_x=422+1;
        }  

        if (Coord_P_x==430 && (Coord_P_y>60 && Coord_P_y<530) ){ 
        Coord_P_x=430-1;
        }    
        
        if (Coord_P_x==562 && (Coord_P_y>60 && Coord_P_y<361) ){  
        Coord_P_x=562+1;
        }          

        if (Coord_P_x==619 && (Coord_P_y>46 && Coord_P_y<340) ){ 
        Coord_P_x=619-1;
        }  
        
        if (Coord_P_x==749 && (Coord_P_y>46 && Coord_P_y<172) ){  
        Coord_P_x=749+1;
        }  
        
        if (Coord_P_x==651 && (Coord_P_y>530 && Coord_P_y<550) ){ 
        Coord_P_x=651-1;
        }         
        
        if (Coord_P_x==785 && (Coord_P_y>361 && Coord_P_y<550) ){  
        Coord_P_x=785+1;
        }   
        
        if (Coord_P_x==790 && (Coord_P_y>340 && Coord_P_y<530) ){ 
        Coord_P_x=790-1;
        } 
        
        if (Coord_P_x==924 && (Coord_P_y>340 && Coord_P_y<361) ){  
        Coord_P_x=924+1;
        }         
        
        if (Coord_P_x==1140 && (Coord_P_y>172 && Coord_P_y<340) ){  
        Coord_P_x=1140+1;
        }    

        if (Coord_P_x==1147 && (Coord_P_y>361 && Coord_P_y<530) ){  
        Coord_P_x=1147+1;
        }    
        
//----------------- Aperte ENTER -----------------        
        if ((Coord_P_y>=534) && (Coord_P_y<=549)&&(Coord_P_x>=376)&&(Coord_P_x<=457)&&(enter==1)){  
        new DecissaoAouB().show();
        enter = 0;
        } 
        if ((Coord_P_y>=152) && (Coord_P_y<=240)&&(Coord_P_x>=397)&&(Coord_P_x<=429)&&(enter==1)){  
        new DecissaoCouD().show();
        enter = 0;
        } 
        if ((Coord_P_y>=346) && (Coord_P_y<=424)&&(Coord_P_x>=1119)&&(Coord_P_x<=1151)&&(enter==1)){  
        new DecissaoEouF().show();
        enter = 0;
        }         
//--------------------Conclusão
        if ((Coord_P_y>=346) && (Coord_P_y<=361)&&(Coord_P_x>=925)&&(Coord_P_x<=965)&&(enter==1)){  
        new ConclusaoLabirinto().show();
        enter = 0;
        }        
    ...
    if (botao_escolhido == KeyEvent.VK_RIGHT){//Se for igual a seta para diraita
     ...
     if (aperte_enter == KeyEvent.VK_ENTER){//Criado para que a caixa com as opções que ficam no tapete apareçam
     enter = 0; // Se soltar enter ele recebe 0       
    }  
    }        
}
